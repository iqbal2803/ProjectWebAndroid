...
if(isset($_POST['tambah'])){
	...
	$gambar	        = $_POST['gambar'];	//membuat variabel $jurusan dan datanya dari inputan dropdown Jurusan
	
	//melakukan query dengan perintah INSERT INTO untuk memasukkan data ke database
	$input = mysql_query("INSERT INTO barang VALUES('$id_barang', '$nama_barang', '$harga', '$stok','$gambar')") or die(mysql_error());
	
	//jika query input sukses
	if($input){
		
		echo 'Data berhasil di tambahkan! ';		//Pesan jika proses tambah sukses
		echo '<p><a href="index.php?page=barang">Kembali</a>';	//membuat Link untuk kembali ke halaman tambah

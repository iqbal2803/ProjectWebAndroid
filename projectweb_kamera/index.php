...
<div id="header"><center><img class="img-responsive" src="assets/img/focusnusantara.png"></center></div>
<nav id="main-nav" role="navigation">
  ...
  <ul id="main-menu" class="sm sm-mint">
   ...
   <?php if($_SESSION['hak_akses']=='Admin'){?>
	...
	<li><a href="#">Laporan</a>
      <ul>
        <li><a href="index.php?page=report_barang">Laporan Barang</a></li>
      </ul>
    </li>
...
function auto_copyright($startYear = null) {
 ...
 <marquee>
 Copyright <?php auto_copyright(); // Current year?>. <a>Design by <a href="">MIF B</a>.
 </marquee>
 </div>
</div>
</body>
